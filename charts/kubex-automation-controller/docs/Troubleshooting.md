...
helm template . -f kubex-automation-values.yaml --debug

# Dry-run deployment
helm upgrade kubex-automation-controller . -f kubex-automation-values.yaml --dry-run
```
...
2. Run `helm upgrade kubex-automation-controller . -f kubex-automation-values.yaml`
...
helm upgrade kubex-automation-controller . -f kubex-automation-values.yaml --dry-run --debug
```
